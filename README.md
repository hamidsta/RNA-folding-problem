...
Therefore dataset_training contain a set of valid RNA PDB files to run the script - dataset_test contain one pdb file to run script linear interpolation
